...
async function findRealProxyWallet() {
    ...
    console.log('2. Connect the wallet you control using your normal wallet software\n');
    console.log('3. Open browser console (F12)\n');
    console.log('4. Execute:\n');
    console.log('   localStorage\n');
    console.log('   or\n');
    console.log('   window.ethereum.selectedAddress\n');
    console.log('5. Copy the address you see there\n');
    console.log('6. Send me this address\n');
